...
class Army extends Defence {
    ...
    void Attack(){
        System.out.println("Army Attack Initiated");
    }
...
class Navy extends Defence {
    ...
    void Attack(){
        System.out.println("Navy Attack Initiated");
    }
...
// Airforce class
    class Airforce extends Defence {
        ...
        void Attack(){
            System.out.println("Airforce Attack Initiated");
        }
...
class TestDefence {
    public static void main(String[] args) {
        Defence a;
        a = new Army(10, 20, 30, 4);
        a.Attack();
        a = new Navy(30, 5, 15);
        a.Attack();
        a = new Airforce(75, 50, 10);
        a.Attack();
